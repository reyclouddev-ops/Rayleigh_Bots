...
export default {
  ...
  description:
    "Membuat tampilan panggilan WhatsApp iPhone (iOS) palsu",
...
Kirim foto atau reply foto dengan format:
\`${prefix + command} Nama|Durasi\`

📌 *Contoh:*
\`${prefix + command} my heart ❤️ | 01:00:39\``
      )
    }
    ...
    try {
      ...
      statusMsg =
        await sock.sendMessage(
          ...
          {
            text:
              "⏳ *Memproses pembuatan Fake Call iOS...*"
          },
          {
            quoted: m
          }
      ...
      const BG_URL =
        "https://raw.githubusercontent.com/ryyntwx/allimagerin/refs/heads/main/353dc125-a39c-4d27-9ba5-9ec7dfa6624a.png"
      ...
      await drawTextWithEmojisCenter(
        ...
        angkaY,
        angkaSize,
        `400 ${angkaSize}px RobotoWA, sans-serif`
      )
